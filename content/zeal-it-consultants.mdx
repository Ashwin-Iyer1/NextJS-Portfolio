...
import firstDay from "./zealPhotos/firstDay.webp";
import interns from "./zealPhotos/interns.webp";
import lunch1 from "./zealPhotos/lunch1.webp";
import golf from "./zealPhotos/golf.webp";
import lastDay from "./zealPhotos/lastDay.webp";
...
{" "}
<br />
<center style={{ paddingTop: "8px", paddingBottom: "20px" }}>
  "The workday does not end at 5pm, it ends when the project is done."
</center>
<Image src={bonusly} alt="Bonusly" height={200} className="center-image" />
<div className="zeal-image flex flex-col items-center justify-center" style={{display: "flex", gap: 15, alignItems: "center", justifyContent: "center"}}>
...
<Image src={firstDay} alt="first day" height={320} className="flex-image" />
<center>
First day of work!
</center>
</div>
...
<Image src={lastDay} alt="first day" height={320} className="flex-image" />
<center>
Last day of work!
</center>
</div>
...
<center> 
<div className="zeal-image-big flex flex-col items-center justify-center" style={{display: "flex", gap: 15, alignItems: "center"}}>
<Image src={interns} alt="interns" height={320} className="flex-image" style={{alignItems: "center"}} />
<Image src={lunch1} alt="lunch 1" height={320} className="flex-image" />
<Image src={golf} alt="golf" height={320} className="flex-image" />
</div>
</center>

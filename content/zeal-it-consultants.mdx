...
<div className="flex flex-col items-center justify-center" style={{display: "flex", gap: 15, alignItems: "center", justifyContent: "center"}}>
...
<center> <Image src={firstDay} alt="first day" height={320} className="flex-image" />
First day of work!
</center>

  <div className="flex flex-col items-center justify-center" style={{display: "flex", gap: 15}}>

<Image src={interns} alt="interns" height={320} className="flex-image" />
